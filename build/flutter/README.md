...
* `flet_apk` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `flet-apk` - executable or bundle name on disk.
* `flet-apk` - display name shown in window titles and about app dialogs.
